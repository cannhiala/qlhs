...
namespace BUS
{
    public class HocSinhBUS
    {
        ...
        public void HienThiHocSinhTheoLop(string namHoc, string khoiLop, string lop, ComboBoxEx comboBox)
        {
            comboBox.DataSource = HocSinhDAO.Instance.LayDanhSachHocSinhTheoLop(namHoc, khoiLop, lop);
